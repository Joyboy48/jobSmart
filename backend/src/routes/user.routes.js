...
import { changeCurrentPassword, getCurrentUser, loginUser, logoutUser, refreshingAccessToken, registerUser, updateAccountDetails, updateProfileImage } from "../controllers/user.controllers.js";
